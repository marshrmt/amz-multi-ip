...
AMZ_AWG_VENDOR_BASE_URL="${AMZ_AWG_VENDOR_BASE_URL:-https://raw.githubusercontent.com/marshrmt/amz-multi-ip/main/vendor/amneziawg-installer}"
COMMON_SCRIPT_URL="${AMZ_AWG_VENDOR_BASE_URL}/awg_common_en.sh"
COMMON_SCRIPT_PATH="$AWG_DIR/awg_common.sh"
MANAGE_SCRIPT_URL="${AMZ_AWG_VENDOR_BASE_URL}/manage_amneziawg_en.sh"
